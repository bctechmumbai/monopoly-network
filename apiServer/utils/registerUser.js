...
async function main() {
  try {
    ...
    const caURL = ccp.certificateAuthorities["ca.vyapar.bcngame.in"].url;
    ...
    const secret = await ca.register(
      {
        affiliation: "vyapar.playstationone",
    ...
    console.log(
      `Successfully registered and enrolled client user ${userName} and imported it into the wallet`
    );
  } catch (error) {
