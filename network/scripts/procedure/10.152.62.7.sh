...
./3-registerPeerOrganization.sh fcs.bepds.gov.in fcs peer1
./3-registerPeerOrganization.sh fci.bepds.gov.in fci peer1

export ORDERER_TLS_CRYPTO_PATH=/blockchain_network/Organizations/ordererOrganizations/mhbcn.gov.in/orderers/orderer2.mhbcn.gov.in/tls/tlscacerts
...
./4-startPeer.sh fcs.bepds.gov.in fcs peer1
...
./4-startPeer.sh fci.bepds.gov.in fci peer1


##Register Orderer 
export $(grep -v '^#' ../.env | xargs)

./5-registerOrdererOrganization.sh mhbcn.gov.in mhbcn orderer2


##Start Orderer2
## Make sure the genesis block is generated and transferred to this node

./8-startOrderer.sh mhbcn.gov.in mhbcn orderer2
